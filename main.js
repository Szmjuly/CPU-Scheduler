...
class Scheduler{
		...
		// {
			...
			if(this.currentTime === this.startTime) {
				...
				if(parseInt(this.readyQueue[0].timings[0], 10) <= timeQuantum1) {	// Dont have to check the priority as each process starts off in queue 1 and gets preempted					
					...
					console.log("\t\t\t  ", "The Ready Queue:", "| Arrival Time\t The I/O Queue:", "| Arrival Time");
					for (let t in this.ioQueue) {
						for(let k = 0; k < this.readyQueue.length; k++){
							if(k === 0)
								console.log("\t\t\t\t  " + this.readyQueue[k].pid + "\t\t  ", this.readyQueue[k].arrivalTime, "\t\t       " + this.ioQueue[t].pid, "\t     ", this.ioQueue[t].arrivalTime)
							else
								console.log("\t\t\t\t  " + this.readyQueue[k].pid + "\t\t  ", this.readyQueue[k].arrivalTime);
						}
					}
					console.log("%c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 'color: red');
				}
	...
	checkForQ1(){
		...
		for(let i = this.readyQueue.length; i >= 0; i--) {
			...
			if(i != this.readyQueue.length){
				console.log("\t   The amount of processes in the readyQueue is:", i, " which is not equal to the length of the readyQueue", this.readyQueue.length);
				console.log("\t\t\t\t  So we go to check if any processes finished in I/O");
				this.checkIOQueue();
			}
			...
			if(this.readyQueue[0].priority === 1) {
				...
				if(parseInt(this.readyQueue[0].timings[0], 10) <= this.readyQueue[0].timeQuantum) {
					...
					console.log("\t\t\tProcess:", this.readyQueue[0].pid, "has finished its burstTime and its removed from the timings array");
					console.log("\t\t\t " + this.readyQueue[0].pid + "'s timing array:",this.readyQueue[0].timings);
					this.readyQueue[0].timings.shift();
					console.log("\t\t    " + this.readyQueue[0].pid + "'s timing array updated:",this.readyQueue[0].timings);
					...
					// Theres some issue here with the printing of the processes in the IO Queue
					console.log("%c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 'color: red');
					console.log("\t\t\t  ", "The Ready Queue:", "| Arrival Time\t The I/O Queue:", "| Arrival Time");
					for (let k in this.readyQueue) {
						for(let t = 0; t < this.ioQueue.length; t++){
						if(k === 0)
							console.log(k)	
						else if (t + 1 < this.ioQueue.length)
							console.log(k, "\t", t);
						}
					}
					console.log("%c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 'color: red');
	...
	checkIOQueue(){
		...
		for(let i in this.ioQueue) {
			console.log("\t\t\t\t\t\t    Checking I/O")

			// Printing out the Processes in the I/O Queue
			console.log("%c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 'color: red');
			console.log("\t\t\t\t\t  ", "The I/O Queue:", "| Arrival Time");
			for (let i in this.ioQueue) {
				console.log("\t\t\t\t\t\t  " + this.ioQueue[i].pid, "\t        ", this.ioQueue[i].arrivalTime)
			}
			console.log("%c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$", 'color: red');
            
			console.log("\t\t\t\t\t  Checking if:", this.ioQueue[0].pid, "Has finished in IO");
			console.log("\t\t\t\t\t        The current time is:", this.currentTime)
			console.log("\t\t\t\t\t\t", this.ioQueue[0].pid + "'s arrivalTime:", this.ioQueue[0].arrivalTime);
